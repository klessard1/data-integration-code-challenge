...
2. Publish API data to a topic.
3. Add a consumer to your API to consume from the topic and perform an operation of your choice with the message, .i.e. log to console, write to database, write to file.
